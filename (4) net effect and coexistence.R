...
figs1 <- ggarrange(dist_multi_plot, dist_net_effect_plot,
  common.legend = T,
...
new.data <- expand.grid(
  min.distance = seq(min(long_data_net_effect_threshold_control$min.distance),
...
# I modified the random factor by introducing "speciesmat" which is a presence/absence matrix of which 3 species is present in each plot
...
modelplot(long_reliability_threshold_control_dist,
