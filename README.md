...
- The second one, "time_to_extinction_tool_no_SE" was authored by Oscar Godoy and modified by me, in order to compute the predicted evenness and abundances for our communities. Its output are the text files "bh_predicted_evenness_15y_2022", "abundances_predictedBH_all_plots" and "years_to_extinction_triplets", they are analysed in the main code file number (5).

- The third one, "multimembership_function" contains functions that I used to run multimemberships models more effectively.
